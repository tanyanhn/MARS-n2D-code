...
std::vector<Real> solveL(const std::vector<Real> &a, const std::vector<Real> &p,
                         const std::vector<Real> &rhs) {
  assert((int)a.size() + 1 == (int)p.size() &&
         (int)p.size() == (int)rhs.size());
  int N = rhs.size();
...
std::vector<Real> solveU(const std::vector<Real> &q,
                         const std::vector<Real> &rhs) {
...
std::vector<Real> solveD(const std::vector<Real> &t, Real s,
                         const std::vector<Real> &rhs) {
...
std::vector<Real> solvePeriodicTri(const std::vector<Real> &a,
...
std::vector<Real> solveLowerTri(const std::vector<Real> &a,
...
std::vector<Real> solveUpperTri(const std::vector<Real> &q,
                                const std::vector<Real> &rhs) {
...
std::vector<Real> solveLsp(const std::vector<Real> &a,
                           const std::vector<Real> &p, const Real e,
                           const std::vector<Real> &rhs) {
  assert((int)a.size() + 1 == (int)p.size() &&
         (int)p.size() == (int)rhs.size());
  int N = rhs.size();
  ...
  result[N - 1] =
      (rhs[N - 1] - result[N - 2] * a[N - 2] - result[N - 3] * e) / p[N - 1];
  return result;
}

std::vector<Real> solveUsp(const std::vector<Real> &q, const Real d,
                           const std::vector<Real> &rhs) {
  assert((int)q.size() + 1 == (int)rhs.size());
  int N = rhs.size();
  std::vector<Real> result(N);
...
std::vector<Real> solveTri(const std::vector<Real> &a,
                           const std::vector<Real> &b,
                           const std::vector<Real> &c,
                           const std::vector<Real> &rhs) {
...
std::vector<Real> solveTrisp(const std::vector<Real> &a,
                             const std::vector<Real> &b,
                             const std::vector<Real> &c, const Real d,
                             const Real e, const std::vector<Real> &rhs) {
  assert(b.size() == rhs.size() && a.size() == b.size() - 1 &&
         c.size() == b.size() - 1);
  int N = rhs.size();
