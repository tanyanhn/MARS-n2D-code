...
enum Type_Minor { ForwardEuler = 0, ClassicRK4, PrinceDormand8, SDIRK2, ESDIRK4, nRK_Type };
}  // namespace RK
...
struct ButcherTableau<RK::ERK, RK::PrinceDormand8> {
    ...
    static constexpr Real c[] = {
        0, 1.0 / 18, 1.0 / 12, 1.0 / 8, 5.0 / 16, 3.0 / 8, 59.0 / 400,
        93.0 / 200, 5490023248.0 / 9719169821, 13.0 / 20, 1201146811.0 / 1299019798, 1, 1
    };
};
