...
constexpr Real ButcherTableau<RK::ERK, RK::ForwardEuler>::a[][ButcherTableau<RK::ERK, RK::ForwardEuler>::nStages];
...
constexpr Real ButcherTableau<RK::ERK, RK::ClassicRK4>::a[][ButcherTableau<RK::ERK, RK::ClassicRK4>::nStages];
...
constexpr Real ButcherTableau<RK::DIRK, RK::SDIRK2>::a[][ButcherTableau<RK::DIRK, RK::SDIRK2>::nStages];
...
constexpr Real ButcherTableau<RK::DIRK, RK::ESDIRK4>::a[][ButcherTableau<RK::DIRK, RK::ESDIRK4>::nStages];
