...
class TestIT {
 ...
 public:
  ...
  TestIT(Point _center, Real _radio, int _n, Real _dt, Real _T,
         VectorFunction<2> *_v, std::string _name, int _opstride,
         Real _rtiny = 0.1)
      : center(_center),
        radio(_radio),
        dt(_dt),
...
TestIT getTest(int i) {
  ...
  // 1.92e+00  3.01e+02
  test.push_back(
      TestIT(Point{0.5, 0.75}, 0.15, 64, 0.04, 8, vortex, "Vortex", 100, 0.01));
  ...
  test.push_back(TestIT(Point{0.5, 0.5}, 0.15, 128, 0.01, 2, deformation,
                        "Deformation", 40, 0.01));
  ...
  test.push_back(TestIT(Point{0.5, 0.5}, 0.15, 256, 0.005, 2, deformation,
                        "Deformation", 50));

  // test 4
  // Vortex(8) plot use
  test.push_back(TestIT(Point{0.5, 0.75}, 0.15, 128, 0.01, 8, vortex, "Vortex",
                        100, 0.01));
  ...
  test.push_back(TestIT(Point{0.5, 0.5}, 0.15, 128, 0.04, 2, deformation,
                        "Deformation", 40, 0.01));
  ...
  test.push_back(TestIT(Point{0.5, 0.5}, 0.15, 128, 0.02, 2, deformation,
                        "Deformation", 40, 0.01));
  ...
  // 2.92e+02
  test.push_back(TestIT(Point{0.5, 0}, 0.5, 16, 0.1, 2, revrotation,
                        "RevRotation", 40, 0.1));

  // test 10
  // CircleShrink
  // n = 32; dt = 0.05; rtiny = 0.3
  test.push_back(TestIT(Point{0, 0}, 1, 32, 0.05, 0.5, circleshrink,
                        "CircleShrink", 5, 0.3));
