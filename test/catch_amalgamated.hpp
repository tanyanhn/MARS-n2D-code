...
sample jackknife(Estimator&& estimator, std::vector<double>::iterator first,
                 std::vector<double>::iterator last) {
...
#define CATCH_INTERNAL_DEFINE_EXPRESSION_EQUALITY_OPERATOR(id, op)             \
  ...
  friend auto operator op(ExprLhs&& lhs, RhsT rhs) -> std::enable_if_t<        \
      Detail::conjunction<                                                     \
          ...
          Detail::is_eq_0_comparable<LhsT>, /* We allow long because we want   \
  ...
  friend auto operator op(ExprLhs&& lhs, RhsT rhs) -> std::enable_if_t<        \
      Detail::conjunction<                                                     \
          Detail::negation<Detail::is_##id##_comparable<LhsT, RhsT>>,          \
          Detail::is_eq_0_comparable<RhsT>, /* We allow long because we want   \
                                               `ptr op NULL` to be accepted */ \
...
std::enable_if_t<std::is_integral<T>::value, GeneratorWrapper<T>> random(T a,
  ...
  static_assert(!std::is_same<T, char>::value &&
                    ...
                    !std::is_same<T, bool>::value,
                "The requested type is not supported by the underlying random "
                "distributions from std");
  return GeneratorWrapper<T>(
...
template <typename ForwardIter, typename Sentinel, typename T,
          typename Comparator>
ForwardIter find_sentinel(ForwardIter start, Sentinel sentinel, T const& value,
                          Comparator cmp) {
...
template <typename ForwardIter, typename Sentinel, typename T,
          typename Comparator>
std::ptrdiff_t count_sentinel(ForwardIter start, Sentinel sentinel,
...
bool check_element_counts(ForwardIter1 first_1, const Sentinel1 end_1,
...
template <typename ForwardIter1, typename Sentinel1, typename ForwardIter2,
          typename Sentinel2, typename Comparator>
bool is_permutation(ForwardIter1 first_1, const Sentinel1 end_1,
                    ForwardIter2 first_2, const Sentinel2 end_2,
                    Comparator cmp) {
...
RangeEqualsMatcher<RangeLike, Equality> RangeEquals(RangeLike&& range,
                                                    Equality&& predicate) {
 ...
 */
template <typename RangeLike, typename Equality>
UnorderedRangeEqualsMatcher<RangeLike, Equality> UnorderedRangeEquals(
