...
int main(int argc, char* argv[])
{
  ...
  // Load the Yin sets and calculate the Hasse diagram.
  {
    ...
    cout << "Betti numbers = " << panda->getBettiNumber(0) << ", " << panda->getBettiNumber(1) << endl << endl;
  }
  {
...
//    *mickey = mickey->translate({-1.0, 0.0});
    ...
    cout << "Betti numbers = " << mickey->getBettiNumber(0) << ", " << mickey->getBettiNumber(1) << endl << endl;
  }
...
//  }
  ...
  // Test intersection
  {
    ...
    cout << "Betti numbers = " << cap.getBettiNumber(0) << ", " << cap.getBettiNumber(1) << endl << endl;
  ...
  // Test union
  {
    ...
    auto sCup = meet(sPanda.complement(), sMickey.complement(), tol).complement();
    YinSet<Dim, Order> cup(sCup, tol);
    cout << "Hasse of panda-mickey union:\n";
    cout << cup.getHasseString() << endl;
    cout << "Betti numbers = " << cup.getBettiNumber(0) << ", " << cup.getBettiNumber(1) << endl << endl;
